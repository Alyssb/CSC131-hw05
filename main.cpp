...
/**
 * TODO: Create function prototypes for any functions you'll implement below main that you'll call from main.
 */
...
int main()
{
     ...
     *
     * If the user selects option 1 of the high-level menu, then present a secondary menu that has five menu items:
     ...
     *
     * If the user selects option 2 of the high-level menu, then present a secondary menu that has five menu items:
     ...
     * 5. Select this option to go back to the high-level menu
     *
     * If the user select option 3 of the high-level menu, the ask the user if they are sure they want to quit.
     ...
     *
     * Strive for modularity, i.e., do not have a bloated main function; points will be deducted if you don't make use
...
/**
 * TODO: Implement any helper functions specified in your forward declarations that precede the main function here.
 * Erase this multi-line comment when you have finished implementing your helper functions.
 */
